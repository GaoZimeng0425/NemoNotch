...
| **AI Chat** | 统一 Claude Code、Gemini CLI、opencode 与 zcode 监控 — 会话列表、对话详情、权限审批、Context 用量进度条、子代理追踪、模型显示 |
